...
statsRouter.get("/user/:userId/transaction-history", StatsController.getUserTransactionHistory);
statsRouter.get("/user/:userId/referral-stats", StatsController.getUserReferralStats);
// User-specific investment basic stats
statsRouter.get("/user/:userId/investment-basic-stats", StatsController.getUserSimpleInvestmentStats);
